    ...
    return (
        <div className="p-4 space-y-4 h-[80vh] overflow-y-auto">
            ...
            <div className="text-center">
                <div className="mb-3">
                    <Image
                        ...
                        alt="Oliv Recorder Logo"
                        width={64}
                        height={64}
                        className="mx-auto"
                    />
                </div>
                {/* <h1 className="text-xl font-bold text-gray-900">Oliv Recorder</h1> */}
            ...
            <div className="space-y-3">
                <h2 className="text-base font-semibold text-gray-800">What makes Oliv Recorder different</h2>
